...
def KNN_classify(train_data, test_data, k, number_of_classes):
    ...
    for test_point in test_data:
        ...
        test_dist = [[distance(test_point[0], test_point[1], train_data[i][0][0],train_data[i][0][1]), train_data[i][1]] for i in range(len(train_data))]
...
def calculateAccuracy (n_classes, n_item_in_class, k, test_percent):
...
if __name__ == '__main__':
    ...
    calculateAccuracy(n_classes,n_item_in_class,k,test_percent)